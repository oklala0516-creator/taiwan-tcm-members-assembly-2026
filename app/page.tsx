...
export default function Home() {
  ...
  return <main>
    <header className="site-header">
      ...
      <nav aria-label="主要導覽"><a href="#schedule">活動行程</a><a href="#venues">交通場地</a><a href="#guide">行前須知</a></nav>
      <button className="header-cta" onClick={downloadCalendar}>加入行事曆</button>
    </header>

    <section className="hero" id="top">
      <div className="hero-copy">
        <p className="eyebrow">2026 ANNUAL GATHERING</p>
        <h1>從一味藥材，<br />看見產業的共同未來。</h1>
      ...
      <div className="hero-panel" aria-label="活動倒數">
        <div className="herb-orbit orbit-one">芍</div><div className="herb-orbit orbit-two">耆</div><div className="herb-orbit orbit-three">芎</div>
        <div className="date-seal"><span>民國 115 年</span><strong>九月十九</strong><span>桃園平鎮</span></div>
    ...
    <section className="intro-strip" aria-label="活動重點"><div><span>01</span><p><b>源頭管理</b><br />藥材品質與供應鏈實務</p></div><div><span>02</span><p><b>製程參訪</b><br />走進現代化中藥製藥現場</p></div><div><span>03</span><p><b>會員共議</b><br />凝聚產業權益與行動方向</p></div></section>

    <section className="section schedule-section" id="schedule">
      <div className="section-heading"><div><p className="eyebrow">FULL DAY PROGRAM</p><h2>一日行程</h2></div><p>上午深入製藥現場，下午移動至會員大會。點選任一時段，可展開注意事項。</p></div>
    ...
    <section className="section guide-section" id="guide">
      <div className="section-heading"><div><p className="eyebrow">BEFORE YOU GO</p><h2>行前須知</h2></div><p>把一整天走得從容：建議於出發前一天，再確認接駁、服裝與個人需求。</p></div>
    ...
    <section className="faq-section"><div><p className="eyebrow">QUICK ANSWERS</p><h2>常見問題</h2></div><div className="faq-list">
    ...
    <section className="final-cta"><p>台灣中藥權益促進會 主辦</p><h2>一場為中藥專業、品質<br />與未來而來的相聚。</h2><div><button className="primary-button light-button" onClick={downloadCalendar}>加入行事曆</button><button className="outline-button" onClick={() => window.print()}>列印行程</button></div><small>2026 年 9 月 19 日・桃園市平鎮區</small></section>
